...
<head>
    ...
    <title>Curso GIT | AprendiendoAndo</title>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Curso de GIT básico</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item"><a href="../index.php">Estoy aprendiendo</a></li>
                        <li class="breadcrumb-item active">Curso de GIT básico</li>
                    </ol>
                    <div class="card mb-4">
                        <div class="card-body">
                            <p class="mb-0">
                    ...
                    <div class="row mb-2" id="variables">
                        ...
                        <div class="col-md-6">
                            <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative" data-bs-toggle="modal" data-bs-target="#portfolioModal1-Ejemplo">
                                <div class="col p-4 d-flex flex-column position-static">
                                    <strong class="d-inline-block mb-2 text-success">#Ejemplo - Git clone<i class="fas fa-star"></i></strong>
                                    <h3 class="mb-0">Git clone</h3>
                                    <div class="mb-1 text-muted">Jun 13</div>
                                    <p class="card-text mb-auto">Las variables permiten a los ordenadores almacenar y manipular datos de forma dinámica. Hacen esto usando una "etiqueta" para apuntar a los datos en lugar de usar los datos en sí.</p>
                                    <a href="#" class="stretched-link">Continuar leyendo</a>
                    ...
                    <div class="row mb-2" id="variables">
                        <div class="col-md-6">
                            <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative" data-bs-toggle="modal" data-bs-target="#portfolioModal1-variable">
                                <div class="col p-4 d-flex flex-column position-static">
                                    <strong class="d-inline-block mb-2 text-primary">#Nota</strong>
                                    <h3 class="mb-0">Git branch</h3>
                                    <div class="mb-1 text-muted">Ago 13</div>
                                    <p class="card-text mb-auto">Las ramas (branch) son altamente importantes en el mundo de Git. Usando ramas, varios desarrolladores pueden trabajar en paralelo en el mismo proyecto simultáneamente. Podemos usar el comando git branch para crearlas, listarlas y eliminarlas.</p>
                                    <a href="#" class="stretched-link">Continuar leyendo</a>
                                </div>
                                <div class="col-auto d-none d-lg-block">
                                    <img class="bd-placeholder-img" width="50" height="100%" src="../media/azul.jpg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false">
                        ...
                        <div class="col-md-6">
                            <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative" data-bs-toggle="modal" data-bs-target="#portfolioModal1-Ejemplo-variable">
                                <div class="col p-4 d-flex flex-column position-static">
                                    <strong class="d-inline-block mb-2 text-success">#Ejemplo - Git branch<i class="fas fa-star"></i></strong>
                                    <h3 class="mb-0">Git branch</h3>
                                    <div class="mb-1 text-muted">Ago 13</div>
                                    <p class="card-text mb-auto">Las ramas (branch) son altamente importantes en el mundo de Git. Usando ramas, varios desarrolladores pueden trabajar en paralelo en el mismo proyecto simultáneamente. Podemos usar el comando git branch para crearlas, listarlas y eliminarlas.</p>
                                    <a href="#" class="stretched-link">Continuar leyendo</a>
                    ...
                    <div class="row mb-2" id="variables">
                        <div class="col-md-6">
                            <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative" data-bs-toggle="modal" data-bs-target="#portfolioModal1-variable-otra">
                                <div class="col p-4 d-flex flex-column position-static">
                                    <strong class="d-inline-block mb-2 text-primary">#Nota</strong>
                                    <h3 class="mb-0">Git checkout</h3>
                                    <div class="mb-1 text-muted">Ago 14</div>
                                    <p class="card-text mb-auto">Este es también uno de los comandos más utilizados en Git. Para trabajar en una rama, primero tienes que cambiarte a ella. Usaremos git checkout principalmente para cambiarte de una rama a otra. También lo podemos usar para chequear archivos y commits</p>
                                    <a href="#" class="stretched-link">Continuar leyendo</a>
                                </div>
                                <div class="col-auto d-none d-lg-block">
                                    <img class="bd-placeholder-img" width="50" height="100%" src="../media/azul.jpg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false">
                        ...
                        <div class="col-md-6">
                            <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative" data-bs-toggle="modal" data-bs-target="#portfolioModal1-Ejemplo-otra">
                                <div class="col p-4 d-flex flex-column position-static">
                                    <strong class="d-inline-block mb-2 text-success">#Ejemplo - Git checkout<i class="fas fa-star"></i></strong>
                                    <h3 class="mb-0">Git chechout</h3>
                                    <div class="mb-1 text-muted">Ago 14</div>
                                    <p class="card-text mb-auto">Este es también uno de los comandos más utilizados en Git. Para trabajar en una rama, primero tienes que cambiarte a ella. Usaremos git checkout principalmente para cambiarte de una rama a otra. También lo podemos usar para chequear archivos y commits</p>
                                    <a href="#" class="stretched-link">Continuar leyendo</a>
                                </div>
                                    ...
                                    <div class="container">
                                        <div class="row justify-content-center">
                                            <div class="col-lg-8">
                                                ...
                                                <p class="mb-4">
                                                Git clone es un comando para descargarte el código fuente existente desde un repositorio remoto (como Github, por ejemplo). En otras palabras, Git clone básicamente realiza una copia idéntica de la última versión de un proyecto en un repositorio y la guarda en tu ordenador.</p>
                                    ...
                                    <div class="container">
                                        <div class="row justify-content-center">
                                            <div class="col-lg-8">
                                                ...
                                                <!-- Portfolio Modal - Image-->
                                                <p>Hay un par de formas de descargar el código fuente, pero principalmente yo prefiero clonar de la forma con https:</p>
                                                <img class="img-fluid rounded mb-5" src="../media/git-clone.png" alt="..." />
